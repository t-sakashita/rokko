...
program minij_matrix
  ...
  call rokko_generate0(mat, minij_matrix_element0)
...
contains
  ...
  function minij_matrix_element0(i, j)
    double precision :: minij_matrix_element0
    integer, intent(in) :: i, j
    minij_matrix_element0 = dble(min(i, j)) + 1
  end function minij_matrix_element0
