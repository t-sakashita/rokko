...
program frank_matrix
  ...
  call rokko_parameters_set_logical(params, "verbose", .true.)
  call rokko_parameters_set_int(params, "upper_index", 4)
  call rokko_parameters_set_int(params, "lower_index", 2)
  call rokko_parameters_set_double(params, "upper_value", 3.2d0)
  call rokko_parameters_set_double(params, "lower_value", 1.11d0)
