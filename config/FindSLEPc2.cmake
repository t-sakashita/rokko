...
if (SLEPC_DIR)
  ...
  find_library(SLEPC_LIBRARY
    NAMES slepc
    HINTS ${SLEPC_DIR}/lib $ENV{SLEPC_DIR}/lib # modified by Sakashita
    HINTS ${SLEPC_DIR}/${PETSC_ARCH}/lib
    DOC "The SLEPc library"
    )
  mark_as_advanced(SLEPC_LIBRARY)

message(STATUS "Display SLEPC_LIBRARY=${SLEPC_LIBRARY}.")
message(STATUS "Display PETSC_ARCH=${PETSC_ARCH}.")
