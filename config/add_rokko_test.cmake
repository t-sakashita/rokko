...
macro(add_rokko_test)
  ...
  if(RUN_TEST_DIR AND EXISTS ${RUN_TEST_DIR}/run_test.cmake)
    ...
    if(EXISTS ${PROJECT_SOURCE_DIR}/config/run_test.cmake)
      ...
      if(EXISTS ${ROKKO_ROOT_DIR}/share/rokko/run_test.cmake)
        set(RUN_TEST ${ROKKO_ROOT_DIR}/share/rokko/run_test.cmake)
      else(EXISTS ${ROKKO_ROOT_DIR}/share/rokko/run_test.cmake)
        set(RUN_TEST ${CMAKE_INSTALL_PREFIX}/share/rokko/run_test.cmake)
...
endmacro(add_rokko_test)

macro(add_rokko_test_mpi)
  if(${ARGC} EQUAL 1)
    set(name ${ARGV0})
    set(procs 1)
    set(opt "")
  ...
  if(RUN_TEST_DIR AND EXISTS ${RUN_TEST_DIR}/run_test_mpi.cmake)
    ...
    if(EXISTS ${PROJECT_SOURCE_DIR}/config/run_test_mpi.cmake)
      ...
      if(EXISTS ${ROKKO_ROOT_DIR}/share/rokko/run_test_mpi.cmake)
        set(RUN_TEST ${ROKKO_ROOT_DIR}/share/rokko/run_test_mpi.cmake)
      else(EXISTS ${ROKKO_ROOT_DIR}/share/rokko/run_test_mpi.cmake)
        set(RUN_TEST ${CMAKE_INSTALL_PREFIX}/share/rokko/run_test_mpi.cmake)
