macro(components_init)
  ...
  if(DISABLE_SCALAPACK_PDSYEVR)
    set(ROKKO_HAVE_SCALAPACK_PDSYEVR FALSE)
  else(DISABLE_SCALAPACK_PDSYEVR)
    set(ROKKO_HAVE_SCALAPACK_PDSYEVR TRUE)
  endif(DISABLE_SCALAPACK_PDSYEVR)
  if(DISABLE_EIGENEXA)
...
macro(components_check)
  if(NOT ROKKO_HAVE_BOOST)
    set(BUILD_BASE_CXX OFF)
...
macro(components_summary)
  ...
  message(STATUS "  base_c: " ${BUILD_BASE_C})
