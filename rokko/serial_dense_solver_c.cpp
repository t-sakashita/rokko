...
// eigenvalues/eigenvectors, no parameters, routine
void rokko_serial_dense_solver_diagonalize_localized_matrix(struct rokko_serial_dense_solver* solver, const char* routine,
							    struct rokko_localized_matrix* mat, struct rokko_localized_vector* eigvals,
							    struct rokko_localized_matrix* eigvecs) {
  if (mat->major == rokko_matrix_col_major)
    static_cast<rokko::serial_dense_solver*>(solver->ptr)->diagonalize(std::string(routine),
								       *static_cast<rokko::localized_matrix<double, rokko::matrix_col_major>*>(mat->ptr),
								       *static_cast<rokko::localized_vector<double>*>(eigvals->ptr),
								       *static_cast<rokko::localized_matrix<double, rokko::matrix_col_major>*>(eigvecs->ptr));
  else
    static_cast<rokko::serial_dense_solver*>(solver->ptr)->diagonalize(std::string(routine),
								       *static_cast<rokko::localized_matrix<double, rokko::matrix_row_major>*>(mat->ptr),
								       *static_cast<rokko::localized_vector<double>*>(eigvals->ptr));
}

// only eigenvalues, no parameters, routine
void rokko_serial_dense_solver_diagonalize_eigvals(struct rokko_serial_dense_solver* solver, const char* routine,
							    struct rokko_localized_matrix* mat, struct rokko_localized_vector* eigvals) {
  if (mat->major == rokko_matrix_col_major)
    static_cast<rokko::serial_dense_solver*>(solver->ptr)->diagonalize(std::string(routine),
								       *static_cast<rokko::localized_matrix<double, rokko::matrix_col_major>*>(mat->ptr),
...
// only eigenvalues, parameters, routine
void rokko_serial_dense_solver_diagonalize_eigvals_params(struct rokko_serial_dense_solver* solver, const char* routine,
							  struct rokko_localized_matrix* mat, struct rokko_localized_vector* eigvals,
							  struct rokko_parameters* params) {
  if (mat->major == rokko_matrix_col_major)
    static_cast<rokko::serial_dense_solver*>(solver->ptr)->diagonalize(std::string(routine),
...
// eigenvalues/eigenvectors, parameters, routine
void rokko_serial_dense_solver_diagonalize_params(struct rokko_serial_dense_solver* solver, const char* routine,
						  struct rokko_localized_matrix* mat, struct rokko_localized_vector* eigvals,
						  struct rokko_localized_matrix* eigvecs,
						  struct rokko_parameters* params) {
  if (mat->major == rokko_matrix_col_major)
