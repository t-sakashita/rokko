...
PYBIND11_MODULE(pyrokko, m) {
  ...
  py::class_<wrap_grid>(m, "grid")
    ...
    .def(py::init<pybind11::handle const&, grid_row_major_t, int>(), py::arg("comm"), py::arg("major") = grid_row_major, py::arg("lld") = 0)
    .def(py::init<pybind11::handle const&, grid_col_major_t, int>(), py::arg("comm"), py::arg("major") = grid_col_major, py::arg("lld") = 0)
