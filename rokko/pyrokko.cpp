...
PYBIND11_MODULE(pyrokko, m) {
  ...
  py::class_<wrap_grid>(m, "grid")
    ...
    .def(py::init<pybind11::handle const&, std::tuple<int,int> const&, grid_row_major_t>(), py::arg("comm"), py::arg("size"), py::arg("major"))
    .def(py::init<pybind11::handle const&, std::tuple<int,int> const&, grid_col_major_t>(), py::arg("comm"), py::arg("size"), py::arg("major"))
    .def(py::init<pybind11::handle const&, grid_row_major_t, int>(), py::arg("comm"), py::arg("major"), py::arg("lld"))
    .def(py::init<pybind11::handle const&, grid_col_major_t, int>(), py::arg("comm"), py::arg("major"), py::arg("lld"))
  ...
  py::class_<wrap_distributed_crs_matrix>(m, "distributed_crs_matrix")
    ...
    .def("insert", py::overload_cast<int, std::vector<int> const&, std::vector<double> const&>(&distributed_crs_matrix::insert, py::const_))
