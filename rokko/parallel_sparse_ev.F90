...
contains
  ...
  function rokko_parallel_sparse_ev_default_solver()
    implicit none
    character(len=:), pointer :: rokko_parallel_sparse_ev_default_solver

    rokko_parallel_sparse_ev_default_solver => rokko_get_string(&
         & rokko_parallel_sparse_ev_default_solver_c())
  end function rokko_parallel_sparse_ev_default_solver
