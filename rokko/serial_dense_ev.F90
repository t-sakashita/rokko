...
contains
  ...
  function rokko_serial_dense_ev_default_solver()
    implicit none
    character(len=:), pointer :: rokko_serial_dense_ev_default_solver

    rokko_serial_dense_ev_default_solver => rokko_get_string(&
         & rokko_serial_dense_ev_default_solver_c())
  end function rokko_serial_dense_ev_default_solver
