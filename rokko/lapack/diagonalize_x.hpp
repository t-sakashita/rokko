...
#ifndef ROKKO_LAPACK_DIAGONALIZE_X_HPP
#define ROKKO_LAPACK_DIAGONALIZE_X_HPP
...
int diagonalize_x(localized_matrix<double, MATRIX_MAJOR>& mat, double* eigvals,
...
#endif // ROKKO_LAPACK_DIAGONALIZE_X_HPP
