...
parameters diagonalize_dsyevr(Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic,MATRIX_MAJOR>& mat, T* eigvals,
			      parameters const& params) {
  parameters params_out;
  T abstol = params.defined("abstol") ? params.get<T>("abstol") : 0.;
