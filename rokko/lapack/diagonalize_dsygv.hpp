...
#ifndef ROKKO_LAPACK_DIAGONALIZE_SYGV_HPP
#define ROKKO_LAPACK_DIAGONALIZE_SYGV_HPP
...
parameters diagonalize_sygv(Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic,MATRIX_MAJOR>& mata, Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic,MATRIX_MAJOR>& matb,
			     VEC& eigvals,
...
#endif // ROKKO_LAPACK_DIAGONALIZE_SYGV_HPP
