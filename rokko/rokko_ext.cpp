...
class wrap_parameters dummy_parameters;
...
wrap_parameters wrap_rokko_parallel_dense_ev::diagonalize_eigvals(wrap_rokko_distributed_matrix* mat, wrap_rokko_localized_vector* eigvals, wrap_parameters const& params = dummy_parameters) {
  if (mat->get_raw()->major == rokko_matrix_col_major)
...
BOOST_PYTHON_MODULE(rokko_ext) {
  ...
  def("rokko_generate_frank_matrix", &wrap_rokko_frank_matrix_generate_localized_matrix);
  ...
  class_<wrap_rokko_parallel_dense_ev>("rokko_parallel_dense_ev",
    ...
    .def("diagonalize",
         &wrap_rokko_parallel_dense_ev::diagonalize_eigvals, distributed_matrix_diagonalize_eigvals_overloads())
    .def("diagonalize",
         &wrap_rokko_parallel_dense_ev::diagonalize, distributed_matrix_diagonalize_overloads());
  ...
  */
  ...
  def("rokko_generate_frank_matrix", &wrap_rokko_frank_matrix_generate_distributed_matrix);
#endif
}
