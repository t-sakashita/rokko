...
struct rokko_parameters rokko_parallel_sparse_ev_diagonalize_distributed_crs_matrix(
...
struct rokko_parameters rokko_parallel_sparse_ev_diagonalize_distributed_mfree(
