#ifndef ROKKO_EIGEN_SX_DISTRIBUTED_MATRIX_HPP
#define ROKKO_EIGEN_SX_DISTRIBUTED_MATRIX_HPP
...
template<>
class distributed_matrix<rokko::eigen_sx>
{
public:
...
template<>
void print_matrix(const rokko::distributed_matrix<rokko::eigen_sx>& mat)
{
  // each proc prints it's local_array out, in order
...
#endif // ROKKO_EIGEN_SX_DISTRIBUTED_MATRIX_HPP
