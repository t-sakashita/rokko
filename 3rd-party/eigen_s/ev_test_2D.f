       subroutine ev_test_2D(n, a, nma, w, z, nmz)
!
...
!
       ...
       call ev_check_2D_body(n, a(1), nma, w(1), z(1), nmz)
       call MPI_Barrier(MPI_COMM_WORLD,ierr)
       call eigen_free(0)
...
*
*
       subroutine ev_check_2D_body(n, a, nma, w, z, nmz)
!
...
*
       ...
       do i=1,n,1
          ...
          jj_0 = get_owner_node(i, size_of_col,my_col)
          ii_0 = get_owner_node(i, size_of_row,my_row)
