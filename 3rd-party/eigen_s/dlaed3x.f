...
!$OMP PARALLEL PRIVATE(I,II,SWK,TEMP)
      DO 60 J = 1, K
!$OMP BARRIER
!$OMP DO
         DO 40 I = 1, J - 1
...
!      do iii=1,N23
!         print*,"Q2(",iii,")@3.2="
!         print*,Q2(1+(iii-1)*N2+IQ2-1:N2+(iii-1)*N2+IQ2-1)
!      enddo
!      do iii=1,K
!         print*,"S(",iii,")@3.2="
!         print*,S(1+(iii-1)*N23:N23+(iii-1)*N23)
!      enddo
     ...
     $               ZERO, Q( N1+1, 1 ), LDQ )
      ...
      END IF
*
!      print*,"Q updated = (",N1+1,":",N1+N2,")*(1:",K,")"
!      do iii=1,n
!         print*,"Q(",iii,")@3.4="
!         print*,Q(1:n,iii)
!      enddo
...
!      do iii=1,N12
!         print*,"Q2(",iii,")@3.3="
!         print*,Q2(1+(iii-1)*N1:N1+(iii-1)*N1)
!      enddo
!      do iii=1,K
!         print*,"S(",iii,")@3.3="
!         print*,S(1+(iii-1)*N12:N12+(iii-1)*N12)
!      enddo
