...
cd $HOME/build/trilinos-11.4.2-Source
patch -p1 < $SCRIPT_DIR/trilinos-11.4.2-Source.patch
...
cmake \
  ...
  -DCMAKE_CXX_FLAGS="-Kfast -Kopenmp -Xg -mt" -DCMAKE_C_FLAGS="-Kfast -Kopenmp -Xg -mt" \
