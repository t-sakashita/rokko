...
for build_type in $BUILD_TYPES; do
  PREFIX=$PREFIX_ROKKO/rokko/rokko-$ROKKO_VERSION-$ROKKO_RK_REVISION/$build_type
  cd $BUILD_DIR
...
export ROKKO_ROOT=$PREFIX_ROKKO/rokko/rokko-$ROKKO_VERSION-$ROKKO_RK_REVISION
...
export ROKKO_ROOT=$PREFIX_ROKKO/rokko/rokko-$ROKKO_VERSION-$ROKKO_RK_REVISION
EOF
$SUDO cp -f $BUILD_DIR/rokkovars.sh $PREFIX_ROKKO/rokko/rokko-$ROKKO_VERSION-$ROKKO_RK_REVISION
