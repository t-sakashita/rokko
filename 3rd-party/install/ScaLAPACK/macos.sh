...
for build_type in $BUILD_TYPES; do
  PREFIX=$PREFIX_ROKKO/scalapack/scalapack-$SCALAPACK_VERSION-$SCALAPACK_RK_REVISION/$build_type
  cd $BUILD_DIR
...
cat << EOF > $BUILD_DIR/scalapackvars.sh
export SCALAPACK_ROOT=$PREFIX_ROKKO/scalapack/scalapack-$SCALAPACK_VERSION-$SCALAPACK_RK_REVISION
EOF
$SUDO cp -f $BUILD_DIR/scalapackvars.sh $PREFIX_ROKKO/scalapack/scalapack-$SCALAPACK_VERSION-$SCALAPACK_RK_REVISION
