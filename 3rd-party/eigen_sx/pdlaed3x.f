      SUBROUTINE PDLAED3X( ICTXT, K, N, NB, D, DROW, DCOL, RHO, DLAMDA,
...
*     .. Array Arguments ..
     ...
     $                   INDROW( * ), INDX( * ), INDXC( * ), INDXR( * )
      DOUBLE PRECISION   BUF( 1:2*K ), D( * ), DLAMDA( * ), U( LDU, * ),
...
*  =======
*
*  PDLAED3X finds the roots of the secular equation, as defined by the
