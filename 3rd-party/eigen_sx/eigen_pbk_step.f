      subroutine eigen_pbk_step1(z, nmz,
...
!----
     ...
     &                     1.0d+00, ss(1      ,ii_4+i_4), m)
         ...
         ii_step=0
         do i_1=i_2,i_3, 1024
            i_5 = min(i_3-i_1+1,1024)
            do m_1=1,m,32
               m_5 = min(m-m_1+1,32)

               if ( m_5 > 0 .and. i_5 > 0 ) then
                  ii_step=ii_step+1
                  if ( mod(ii_step-1,thread_size)==thread_rank ) then
                     call dgemm('t','n',
     &                    m_5, i_5, j_5,
     &                    1.0d+00, v (j_2    ,m_1      ), nm,
     &                             z (j_2    ,i_1      ), nmz,
     &                    1.0d+00, ss(m_1    ,i_1-i_2+1), m)
                  endif
               endif
      ...
      return
      end subroutine ! eigen_pbk_step1

!----
      subroutine eigen_pbk_step2( z, nmz,
     &                  v, nm, m, ss, sm, i_2,i_3, j_2,j_3 )
      implicit double precision(a-h,o-z),integer(i-n)
!----
      integer :: nmz, nm, m
...
!$omp barrier
     ...
     &               1.0d+00, z (j_2    ,i_2+i_4), nmz)
      ...
      return
      end subroutine ! eigen_pbk_step2
