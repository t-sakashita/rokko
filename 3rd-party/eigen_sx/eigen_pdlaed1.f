      SUBROUTINE EIGEN_PDLAED1( N, N1, D, ID, Q, IQ, JQ, DESCQ, RHO,
     $                          WORK, IWORK, Z, ISTAGE, INFO )
*
...
*
*     .. Scalar Arguments ..
      INTEGER            ID, INFO, IQ, JQ, N, N1, ISTAGE
...
*  =======
*
*  EIGEN_PDLAED1 computes the updated eigensystem of a diagonal
...
*        performed by the routine PDLAED2X.
*
*        The second stage consists of calculating the updated
*        eigenvalues. This is done by finding the roots of the secular
*        equation via the routine SLAED4 (as called by PDLAED3X).
...
*     .. External Subroutines ..
     ...
     $                   INFOG2L, PDGEMM, PDLAED2X, PDLAEDZ,
     $                   PDLASET, PXERBLA, PDLAED3X
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
      real(8) :: t1,t2,z1,z2
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCQ( CTXT_ ), 'EIGEN_PDLAED1', -INFO )
         RETURN
      END IF
*
...
*  
      ...
      CALL DCOPY(N, Z, 1, WORK( IZ ), 1);
*     Deflate eigenvalues.

      IPQ = IIQ + ( JJQ-1 )*LDQ


      CALL PDLAED2X(ICTXT, K, N, N1, NB, D, IQROW, IQCOL, Q( IPQ ),
     $              LDQ, RHO, WORK( IZ ), WORK( IW ), WORK( IDLMDA ),
...
*
      ...
      END IF   
         CALL PDLAED3X( ICTXT, K, N, NB, D, IQROW, IQCOL, RHO,
