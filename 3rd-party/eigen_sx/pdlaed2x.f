      SUBROUTINE PDLAED2X( ICTXT, K, N, N1, NB, D, DROW, DCOL, Q, LDQ,
...
*  =======
*
*  PDLAED2X sorts the two sets of eigenvalues together into a single
...
*     .. Executable Statements ..
      ...
      INTEGER REQ(8192), REQ_PTR, MYRANK, IERR, ST(8192)
      REQ_PTR=0
*
...
!               PRINT*,"IRECV1", MYROW, MYCOL, MYRANK, MYROW+NJCOL*NPROW
               CALL MPI_IRECV( QBUF, NP, MPI_DOUBLE_PRECISION,
     $                         MYROW+NJCOL*NPROW,
     $                         MYROW+NJCOL*NPROW+10000,
     $                         MPI_COMM_WORLD,
     $                         REQ(2), IERR)
!               PRINT*,"IRECVq", MYROW, MYCOL, MYRANK, MYROW+NJCOL*NPROW
!               PRINT*,"ISENDs", MYROW, MYCOL, MYRANK, MYROW+NJCOL*NPROW
               CALL MPI_ISEND( Q(1, PJJ), NP, MPI_DOUBLE_PRECISION,
     $                         MYROW+NJCOL*NPROW,
     $                         MYRANK+10000,
     $                         MPI_COMM_WORLD,
     $                         REQ(1), IERR)
!               PRINT*,"ISENDq", MYROW, MYCOL, MYRANK, MYROW+NJCOL*NPROW
               CALL MPI_WAITALL(2, REQ, ST, IERR)
!               PRINT*,"WAITALL", MYROW, MYCOL, MYRANK, MYROW+NJCOL*NPROW
...
!               CALL DGERV2D( ICTXT, NP, 1, QBUF, NP, MYROW, PJCOL )
               CALL MPI_COMM_RANK(MPI_COMM_WORLD, MYRANK, IERR)
!               PRINT*,"IRECVs", MYROW, MYCOL, MYRANK, MYROW+PJCOL*NPROW
               CALL MPI_IRECV( QBUF, NP, MPI_DOUBLE_PRECISION,
     $                         MYROW+PJCOL*NPROW,
     $                         MYROW+PJCOL*NPROW+10000,
     $                         MPI_COMM_WORLD,
     $                         REQ(2), IERR)
!               PRINT*,"IRECVq", MYROW, MYCOL, MYRANK, MYROW+PJCOL*NPROW
!               PRINT*,"ISENDs", MYROW, MYCOL, MYRANK, MYROW+PJCOL*NPROW
               CALL MPI_ISEND( Q(1, NJJ), NP, MPI_DOUBLE_PRECISION,
     $                         MYROW+PJCOL*NPROW,
     $                         MYRANK+10000,
     $                         MPI_COMM_WORLD,
     $                         REQ(1), IERR)
!               PRINT*,"ISENDq", MYROW, MYCOL, MYRANK, MYROW+PJCOL*NPROW
               CALL MPI_WAITALL(2, REQ, ST, IERR)
!               PRINT*,"WAITALL", MYROW, MYCOL, MYRANK, MYROW+PJCOL*NPROW
