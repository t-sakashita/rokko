      subroutine eigen_sx_init_wrapper(ndim, size_of_col_local,
     &size_of_row_local )
      ...
      return
      end subroutine            ! eigen_sx_init_wrapper


      subroutine eigen_sx_free_wrapper(flag)
      ...
      return
      end subroutine            ! eigen_sx_free_wrapper
