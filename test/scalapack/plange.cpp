...
//   // generate matrix
//   rokko::slmatrix a(m, n);
//   if (grid.get_myrank() == 0) a = rokko::slmatrix::Random(m, n);
  
//   // distributed matrix
//   rokko::mapping_bc<rokko::matrix_col_major> map(m, n, grid, 1, 1);
//   rokko::distributed_matrix<float, rokko::matrix_col_major> mat(map);
//   rokko::scatter(a, mat, 0);
